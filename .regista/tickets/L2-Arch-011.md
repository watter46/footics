...
context_files:
  - src/features/tactical-unified/panels/hud/
...
- [x] `src/features/tactical-unified/panels/hud/` および `panels/toolbar/` が作成され、該当コンポーネントが移動している
- [x] `tactical-unified-page.tsx`, `top-header.tsx`, `index.ts` 等のインポートパスが更新されている
- [x] Biome チェック、スコープ付き型チェック、テストがパスしている

### Verification
`rtk biome check src/features/tactical-unified/panels/hud src/features/tactical-unified/panels/toolbar`
`rtk pnpm type-check:scoped src/features/tactical-unified/panels/hud/index.ts src/features/tactical-unified/panels/toolbar/index.ts`
`rtk vitest run src/features/tactical-unified/panels/hud src/features/tactical-unified/panels/toolbar`
