...
import { createCanvasNodesRegistry } from '@/components/features/tactical-unified/canvas/canvas-registry';
import { useTacticalAnimation } from '@/components/features/tactical-unified/hooks/use-tactical-animation';
import {
