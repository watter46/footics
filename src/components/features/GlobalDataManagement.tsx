            ...
            <div className="p-1.5 flex flex-col gap-1">
              ...
              >
                ...
                <div className="flex flex-col items-start leading-tight">
                  <span className="font-medium text-slate-200">Full Backup (.zip)</span>
                  <span className="text-[10px] text-slate-500">Export matches, memos, and events</span>
                </div>
                {isProcessing && <RefreshCw className="ml-auto w-3.5 h-3.5 animate-spin opacity-50" />}
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start leading-tight">
                  <span className="font-medium text-slate-200">Restore Data</span>
                  <span className="text-[10px] text-slate-500">Merge from existing backup ZIP</span>
                </div>
              </button>
            </div>
