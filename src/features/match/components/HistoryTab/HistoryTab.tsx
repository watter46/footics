...
import { HistoryEventCard } from './parts/EventCard';
import { TimelineHeader } from './parts/TimelineHeader';
import { HistoryTimelineMarker } from './parts/TimelineMarker';
...
export const HistoryTab = ({ match }: HistoryTabProps) => {
  const { events, ownTeamName, opponentTeamName } = useHistoryTab(match);
